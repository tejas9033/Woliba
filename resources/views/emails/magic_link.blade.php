    ...
    <body>
        <div class="email-wrapper">
            <div style="padding: 40px; padding-bottom: 0;">
                ...
                <p>Are you ready to kickstart your wellness journey and unlock amazing benefits with Woliba?
                    <br>Just click the button below to get started:
                </p>
                <p style="text-align: center;"><a href="{{ $url }}" class="cta-button">Register Now</a></p>
                <p>After you register, download the Woliba app and log in using the email and password you created
                    during
                    registration.</p>
